package tf.caas.service

import java.{lang, util}

import javax.inject.Inject
import tf.caas.domain.UserInfoPageable
import tf.caas.repository.{FacebookOAuthRepository, GoogleOAuthRepository, OAuthRepository}
import tf.caas.util.ZConfig
import tf.jcaas.core.CAAS
import tf.jcaas.model.dal.{IRoleDAO, IUserDAO}
import tf.jcaas.model.entity.{Pageable, RoleInfo}
